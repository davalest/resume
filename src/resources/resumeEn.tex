...
\begin{document}
    ...
    \cventry{Oct 2019-- Currently }{Capitole Consulting}{Programmer Analyst}{}{Developed projects:}
    {\begin{itemize}
    ...
    \section{Schooling}
    \cventry{Now}{Técnico Superior de Desarrollo de Aplicaciones Web}{}{Ilerna}{Madrid}{}
